# import sys
# sys.path.append('/data/zwt/he2ihc/PSPStain-main')
# from experiments.tmux_launcher import Options, TmuxLauncher
...
class Launcher(TmuxLauncher):
    def common_options(self):
        return [
            # Command 0
            Options(
                dataroot="/data/zwt/he2ihc/PSPStain-main/dataset_BCI",
...
launcher = Launcher()
test_cmds = launcher.test_commands()
